...
OUT = Path("data/processed/phase22_project_final_safety_closeout.json")
RUNTIME_OUT = Path("runtime/phase22_project_final_safety_closeout_state.json")
PHASE22_DIR = Path("data/processed/phase22_project_archive")

CONSOLIDATION = Path("data/processed/phase22_project_final_evidence_seal_consolidation.json")
CONSOLIDATION_RUNTIME = Path("runtime/phase22_project_final_evidence_seal_consolidation_state.json")
CONSOLIDATION_FILE = Path("data/processed/phase22_project_archive/project_final_evidence_seal_consolidation.json")
...
final_evidence_seal_consolidated = (
    consolidation.get("final_evidence_seal_consolidated") is True
    or consolidation_runtime.get("final_evidence_seal_consolidated") is True
    or consolidation_file.get("final_evidence_seal_consolidated") is True
)
...
final_checks = {
    ...
    "phase22_status_final_evidence_seal_consolidated": phase22_status == "final_evidence_seal_consolidated",
...
blockers = [key for key, value in final_checks.items() if value is not True]
project_final_safety_closeout_passed = all(final_checks.values())

if project_final_safety_closeout_passed:
    decision = "PHASE_22_PROJECT_FINAL_SAFETY_CLOSEOUT_COMPLETE_REMAIN_ON_HOLD_NOT_APPROVED_FOR_EXECUTION"
    next_phase = "Phase 22.11 — Project Final Safety Closeout Review"
else:
    decision = "PHASE_22_PROJECT_FINAL_SAFETY_CLOSEOUT_FAILED_REVIEW_REQUIRED"
    next_phase = "Phase 22.11 — Project Final Safety Closeout Fix"

closeout_file = PHASE22_DIR / "project_final_safety_closeout.json"

record = {
    "phase": "phase_22_10_project_final_safety_closeout_record",
    ...
    "phase22_status": "project_final_safety_closeout_complete",
...
report = {
    "phase": "phase_22_10_project_final_safety_closeout",
    "generated_at_unix": int(time.time()),
    "scope": "project_final_safety_closeout_only_no_monitoring_no_dry_run_no_backtest_no_execution",
    "git_head": git_head_value,
    "safety_flags": flags,
    "safe_mode_active": safe_mode,
...
print(f"project_final_safety_closeout_passed={project_final_safety_closeout_passed}")
...
print("phase22_status=project_final_safety_closeout_complete")
