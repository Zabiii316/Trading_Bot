...
OUT = Path("data/processed/phase22_project_final_closeout_review.json")
RUNTIME_OUT = Path("runtime/phase22_project_final_closeout_review_state.json")
PHASE22_DIR = Path("data/processed/phase22_project_archive")

CONSOLIDATION = Path("data/processed/phase22_project_final_closeout_consolidation.json")
CONSOLIDATION_RUNTIME = Path("runtime/phase22_project_final_closeout_consolidation_state.json")
CONSOLIDATION_FILE = Path("data/processed/phase22_project_archive/project_final_closeout_consolidation.json")
...
safety_review = load_json(SAFETY_REVIEW)
...
consolidated = (
    consolidation.get("project_final_closeout_consolidated") is True
    or consolidation_runtime.get("project_final_closeout_consolidated") is True
    or consolidation_file.get("project_final_closeout_consolidated") is True
)

safety_review_passed = safety_review.get("project_final_safety_closeout_review_passed") is True
...
phase22_status = consolidation.get("phase22_status") or consolidation_file.get("phase22_status")
...
review_checks = {
    ...
    "project_final_closeout_consolidated": consolidated,
    ...
    "phase22_status_project_final_closeout_consolidated": phase22_status == "project_final_closeout_consolidated",
...
project_final_closeout_review_passed = all(review_checks.values())

if project_final_closeout_review_passed:
    decision = "PHASE_22_PROJECT_FINAL_CLOSEOUT_REVIEW_COMPLETE_REMAIN_ON_HOLD_NOT_APPROVED_FOR_EXECUTION"
    next_phase = "Phase 22.14 — Project Final Repository Status Check"
else:
    decision = "PHASE_22_PROJECT_FINAL_CLOSEOUT_REVIEW_FAILED_REVIEW_REQUIRED"
    next_phase = "Phase 22.14 — Project Final Closeout Review Fix"

review_file = PHASE22_DIR / "project_final_closeout_review.json"

record = {
    "phase": "phase_22_13_project_final_closeout_review_record",
...
report = {
    "phase": "phase_22_13_project_final_closeout_review",
    "generated_at_unix": int(time.time()),
    "scope": "project_final_closeout_review_only_no_monitoring_no_dry_run_no_backtest_no_execution",
    "git_head": git_head_value,
    "safety_flags": flags,
    "safe_mode_active": safe_mode,
...
print(f"project_final_closeout_review_passed={project_final_closeout_review_passed}")
...
print("phase22_status=project_final_closeout_review_complete")
